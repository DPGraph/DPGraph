...
Download all the files from this folder with the csv files from the link above and put all of them into the same folder with the uploads folder as well.
